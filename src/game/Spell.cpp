...
void Spell::prepareDataForTriggerSystem()
{
        ...
        switch (m_spellInfo->SpellFamilyName)
        {
            ...
            case SPELLFAMILY_ROGUE:   // For poisons need do it
                if (m_spellInfo->SpellFamilyFlags & UI64LIT(0x000000101001E000))
                    m_canTrigger = true;
                break;
            case SPELLFAMILY_HUNTER:  // Hunter Rapid Killing, Explosive Shot need do it
                if ((m_spellInfo->SpellFamilyFlags & UI64LIT(0x0100000000000000)) ||
    ...
    if (m_spellInfo->SpellFamilyName == SPELLFAMILY_HUNTER &&
        (m_spellInfo->SpellFamilyFlags & UI64LIT(0x0000200000002018) || m_spellInfo->SpellFamilyFlags2 & 0x00024000) )
