        ...
        switch(m_spellInfo->SpellFamilyName)
        {
            ...
            case SPELLFAMILY_HUNTER:
            {
                ...
                else if (m_spellInfo->SpellFamilyFlags & UI64LIT(0x100000000))
                {
                    ...
                    base = int32(base * 1000/m_caster->GetAttackTime(RANGED_ATTACK) + ((Player*)m_caster)->GetAmmoDPS() );
                    damage += int32(base*2.8f + m_caster->GetTotalAttackPowerValue(RANGED_ATTACK)*0.1f);
                }
